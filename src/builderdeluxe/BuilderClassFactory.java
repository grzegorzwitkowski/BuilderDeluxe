...
public class BuilderClassFactory {
    ...
    public PsiMethod createFieldMethod(PsiField sourceClassField, PsiClass builderClass) {
        return psiFacade.createMethodFromText(codeGenerator.fieldMethod(sourceClassField), builderClass);
    }
